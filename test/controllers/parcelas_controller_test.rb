...
class ParcelasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcela" do
    assert_difference('Parcela.count') do
      post parcelas_url, params: { parcela: { nombre: @parcela.nombre, tipo: @parcela.tipo } }
    end
  ...
  test "should update parcela" do
    patch parcela_url(@parcela), params: { parcela: { nombre: @parcela.nombre, tipo: @parcela.tipo } }
